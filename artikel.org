...
\newenvironment{compactenumerate}{\begin{itemize}[noitemsep]}{\end{itemize}}
...
\newcommand{\bv}[2]{%
  \immediate\write18{btooltip.sh #1 #2 \languagename > #1#2.\languagename{}-btooltip}
  {\setlength{\fboxrule}{0pt}\input{#1#2.\languagename{}-btooltip}}
}
