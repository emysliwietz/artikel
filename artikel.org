...
BoldFont = *12-Bold, % set EB Garamond 12 as default italic font
BoldFeatures = {
  SizeFeatures = {
    {Size = -10.1,
      Font = *08-Bold}, % use EB Garamond 08 for 10pt size and smaller
    {Size = 10.1-}
  }
}, % use default italic font for larger than 10pt size
...
\makeatother
#+end_src
** Workaround for basic Garamond
#+begin_src latex
\providefontfamily{\BasicEBGaramond}{BasicEBGaramond}[
  Path = /home/user/.fonts/EBGaramond/,
  Extension = .otf,
  UprightFont = *12-Regular,
]
%\newfontfamily\basicgaramondfont{BasicEBGaramond}
% some characters are only defined this way
\begin{luacode}
  function addcharsebgaramond(start, finish)
    for i=start,finish do
      tex.sprint("\\newunicodechar{" .. unicode.utf8.char(i) .. "}{{\\BasicEBGaramond{"..unicode.utf8.char(i).."}}}")
    end
  end
\end{luacode}

 %- Tonal markers
 \directlua{addcharsebgaramond(0x0301, 0x0301)}
 \directlua{addcharsebgaramond(0x0303, 0x030B)}
...
#+end_src
** Geeza Pro (Arabic script)
#+begin_src latex
\setotherlanguage{arabic}
\setotherlanguage{persian}
\newfontfamily\arabicfont[Script=Arabic]{GeezaPro}
\newfontfamily\arabicfonttt[Script=Arabic]{GeezaPro}
