...
\begin{luacode}
  function addcharsCJK(start, finish)
    for i=start,finish do
      tex.sprint("\\newunicodechar{" .. unicode.utf8.char(i) .. "}{{\\CJKfont{" .. unicode.utf8.char(i) ..   "}}}")
    end
  end

  -- CJK Unified Ideographs (4E00-9FFF)
  addcharsCJK(0x4E00, 0x9FFF)

  -- CJK Unified Ideographs Extension A (3400-4DBF)
  addcharsCJK(0x3400, 0x4DBF)

  -- Partially cover CJK Unified Ideographs Extension B (20000-2A6DF)
  addcharsCJK(0x20000, 0x2A6DF)
\end{luacode}
#+end_src
** Times New Roman
#+begin_src latex
