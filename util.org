#+title: Util.sty
#+sub_title: Collection for all kinds of latex commands I reuse
#+property: header-args :tangle util.sty

* Disclaimer
#+begin_src latex
% util.sty - Collection for all kinds of latex commands I reuse
%
% <–––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––>
...
% from Dr. Engelbert Hubbers as well various other authors
% <–––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––>
\ProvidesPackage{util}[2018/11/30 v2.0.0 personal shortcuts]
...
\RequirePackage{blindtext}        % Provides the \blindtext command, which produces dummy text for testing
...
\RequirePackage{capt-of}         % Provides support for captions on figures or tables that have been "cut out" of their normal environments
...
\RequirePackage[automark,draft=false,headwidth=textwithmarginpar,footwidth=head]{scrlayer-scrpage} % scrtcl fixes
...
\RequirePackage{subfigure}        % Provides the subfigure environment for typesetting figures side-by-side
